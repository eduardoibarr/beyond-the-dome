...
class InventoryUI:
    def __init__(self, game, inventory):
        ...
        # Calculate window dimensions with better spacing
        self.window_width = self.cols * (self.slot_size + self.slot_padding) + self.slot_padding * 2
        self.window_height = self.rows * (self.slot_size + self.slot_padding) + 150  # More space for info
        ...
        print("[DEBUG] InventoryUI inicializado")
    ...
    def draw(self, screen):
        ...
        # Draw semi-transparent overlay with better opacity
        overlay = pygame.Surface((WIDTH, HEIGHT))
        overlay.set_alpha(180)
        overlay.fill((0, 0, 0))
        screen.blit(overlay, (0, 0))

        # Draw main inventory background with rounded corners effect
        main_bg = pygame.Surface((self.window_width, self.window_height))
        main_bg.fill((40, 40, 50))  # Dark blue-gray
        ...
        # Draw inventory slots with better spacing
        ...
        for i in range(self.inventory.size):
            ...
            # Draw slot background with better colors
            ...
            if item:
                if item.icon:
                    ...
                    # Better default item representation
                ...
                # Draw quantity with better positioning
        ...
        # Draw selected item info with better layout
        ...
        # Draw close instruction at the bottom
        ...
        print("[DEBUG] Inventário desenhado com sucesso")
    ...
    def handle_input(self, event):
        ...
        if event.type == pygame.KEYDOWN:
            # TAB key is now handled in the main game events, not here
